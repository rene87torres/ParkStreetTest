...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'parkstreet_app.client' => 'getParkstreetApp_ClientService',
            'parkstreet_app.date' => 'getParkstreetApp_DateService',
            'parkstreet_app.invoice' => 'getParkstreetApp_InvoiceService',
            'parkstreet_app.pager' => 'getParkstreetApp_PagerService',
            'parkstreet_app.product' => 'getParkstreetApp_ProductService',
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'park_street', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Parkstreet/AppBundle/Entity'))), 'Parkstreet\\AppBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ParkstreetAppBundle' => 'Parkstreet\\AppBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ef0d22aee8f4a8b61135a948975a81edcfc80ab78085785949582d5fe9726e32');
    ...
    /*
     * Gets the 'parkstreet_app.client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Parkstreet\AppBundle\FileManager\ClientManager A Parkstreet\AppBundle\FileManager\ClientManager instance
     */
    protected function getParkstreetApp_ClientService()
    {
        return $this->services['parkstreet_app.client'] = new \Parkstreet\AppBundle\FileManager\ClientManager($this->get('doctrine.orm.default_entity_manager'), $this->get('security.token_storage'));
    }

    /*
     * Gets the 'parkstreet_app.date' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Parkstreet\AppBundle\Useful\Date\Date A Parkstreet\AppBundle\Useful\Date\Date instance
     */
    protected function getParkstreetApp_DateService()
    {
        return $this->services['parkstreet_app.date'] = new \Parkstreet\AppBundle\Useful\Date\Date();
    }

    /*
     * Gets the 'parkstreet_app.invoice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Parkstreet\AppBundle\FileManager\InvoiceManager A Parkstreet\AppBundle\FileManager\InvoiceManager instance
     */
    protected function getParkstreetApp_InvoiceService()
    {
        return $this->services['parkstreet_app.invoice'] = new \Parkstreet\AppBundle\FileManager\InvoiceManager($this->get('doctrine.orm.default_entity_manager'), $this->get('security.token_storage'));
    }

    /*
     * Gets the 'parkstreet_app.pager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Parkstreet\AppBundle\Useful\Pagination\Pager A Parkstreet\AppBundle\Useful\Pagination\Pager instance
     */
    protected function getParkstreetApp_PagerService()
    {
        return $this->services['parkstreet_app.pager'] = new \Parkstreet\AppBundle\Useful\Pagination\Pager();
    }

    /*
     * Gets the 'parkstreet_app.product' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Parkstreet\AppBundle\FileManager\ProductManager A Parkstreet\AppBundle\FileManager\ProductManager instance
     */
    protected function getParkstreetApp_ProductService()
    {
        return $this->services['parkstreet_app.product'] = new \Parkstreet\AppBundle\FileManager\ProductManager($this->get('doctrine.orm.default_entity_manager'), $this->get('security.token_storage'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Parkstreet/AppBundle/Resources/views'), 'ParkstreetApp');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('581153d6429036.62179697')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ParkstreetAppBundle' => 'Parkstreet\\AppBundle\\ParkstreetAppBundle',

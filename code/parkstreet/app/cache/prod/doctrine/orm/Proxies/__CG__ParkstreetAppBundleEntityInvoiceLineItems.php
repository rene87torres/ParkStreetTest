 ...
 */
class InvoiceLineItems extends \Parkstreet\AppBundle\Entity\InvoiceLineItems implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Parkstreet\\AppBundle\\Entity\\InvoiceLineItems' . "\0" . 'id', '' . "\0" . 'Parkstreet\\AppBundle\\Entity\\InvoiceLineItems' . "\0" . 'qty', '' . "\0" . 'Parkstreet\\AppBundle\\Entity\\InvoiceLineItems' . "\0" . 'price', '' . "\0" . 'Parkstreet\\AppBundle\\Entity\\InvoiceLineItems' . "\0" . 'invoice', '' . "\0" . 'Parkstreet\\AppBundle\\Entity\\InvoiceLineItems' . "\0" . 'product');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (InvoiceLineItems $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setInvoice(\Parkstreet\AppBundle\Entity\Invoice $invoice = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function setProduct(\Parkstreet\AppBundle\Entity\Product $product = NULL)
    {
